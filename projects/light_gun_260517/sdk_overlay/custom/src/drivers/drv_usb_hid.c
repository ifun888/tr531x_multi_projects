...
#if defined(CONFIG_LIGHT_GUN_260517_USB_HID_ENABLE)
#define OF_USB_HID_ENABLE 1
#else
#define OF_USB_HID_ENABLE 0
#endif
...
int drv_usb_hid_init(void)
{
    ...
    const char product[] = { 'L', 0, 'i', 0, 'g', 0, 'h', 0, 't', 0, 'G', 0, 'u', 0, 'n', 0, '2', 0, '6', 0, '0', 0, '5', 0, '1', 0, '7', 0 };
    const char serial[] = { '2', 0, '6', 0, '0', 0, '5', 0, '1', 0, '7', 0 };
