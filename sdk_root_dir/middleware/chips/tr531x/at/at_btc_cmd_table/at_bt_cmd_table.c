...
const at_cmd_entry_t at_bt_cmd_parse_table[] = {
...
#if defined(CONFIG_SAMPLE_SUPPORT_SLE_KEYBOARD) || defined(CONFIG_SAMPLE_SUPPORT_SLE_RCU_SERVER)
    {
        ...
        22,   // ID
        0,    // Attribute
        bt_at_send_key_value_param_syntax,
        NULL,
        (at_set_func_t)bt_at_send_key_value_cmd,
        NULL,
        NULL,
    },
#endif
    {
        ...
        31, // ID
        0,  // Attribute
        bt_write_addr_flash_param_syntax,
        NULL,
        (at_set_func_t)bt_at_set_addr_cmd,
        NULL,
        NULL,
    },
    {
        ...
        0,  // Attribute
        NULL,
        (at_cmd_func_t)bt_at_stop_sle_adv_cmd,
        NULL,
        NULL,
        NULL,
    },
    {
        ...
        0,  // Attribute
        NULL,
        (at_cmd_func_t)bt_at_stop_ble_adv_cmd,
        NULL,
        NULL,
        NULL,
    },
    {
        ...
        0,  // Attribute
        NULL,
        (at_cmd_func_t)bt_at_stop_sle_seek_cmd,
        NULL,
        NULL,
        NULL,
    },
    {
        ...
        0,  // Attribute
        NULL,
        (at_cmd_func_t)bt_at_stop_ble_scan_cmd,
        NULL,
        NULL,
        NULL,
    },
    {
        ...
        0,  // Attribute
        NULL,
        (at_cmd_func_t)bt_at_stay_work_state,
        NULL,
        NULL,
        NULL,
    },
