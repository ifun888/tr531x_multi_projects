...
#define DIEID_EFUSE_BASE_ADDR 0x57028800
#define EFUSE_READ_ENABLE_REG_ADDR 0x57028030
#define EFUSE_READ_ENABLE 0x5A5A
#define DIEID_EFUSE_WORD_LEN 9

#ifndef CONFIG_BG_SLE_ONLY
...
const at_para_parse_syntax_t bt_write_addr_flash_param_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 255,
        .offset = offsetof(bt_write_addr_flash_param_args_t, sle_addr0)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 255,
        .offset = offsetof(bt_write_addr_flash_param_args_t, sle_addr1)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 255,
        .offset = offsetof(bt_write_addr_flash_param_args_t, sle_addr2)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 255,
        .offset = offsetof(bt_write_addr_flash_param_args_t, sle_addr3)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 255,
        .offset = offsetof(bt_write_addr_flash_param_args_t, sle_addr4)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 255,
        .offset = offsetof(bt_write_addr_flash_param_args_t, sle_addr5)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 255,
        .offset = offsetof(bt_write_addr_flash_param_args_t, ble_addr0)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 255,
        .offset = offsetof(bt_write_addr_flash_param_args_t, ble_addr1)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 255,
        .offset = offsetof(bt_write_addr_flash_param_args_t, ble_addr2)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 255,
        .offset = offsetof(bt_write_addr_flash_param_args_t, ble_addr3)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 255,
        .offset = offsetof(bt_write_addr_flash_param_args_t, ble_addr4)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .last = true,
        ...
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 255,
        .offset = offsetof(bt_write_addr_flash_param_args_t, ble_addr5)
    },
};
...
const at_para_parse_syntax_t bt_at_send_key_value_param_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE | AT_SYNTAX_ATTR_OPTIONAL,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 3,
        .offset = offsetof(bt_at_send_key_value_param_args_t, key_nums)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE | AT_SYNTAX_ATTR_OPTIONAL,
        ...
        .offset = offsetof(bt_at_send_key_value_param_args_t, para1)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE | AT_SYNTAX_ATTR_OPTIONAL,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 0xFF,
        .offset = offsetof(bt_at_send_key_value_param_args_t, para2)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .last = true,
        ...
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 0xFF,
        .offset = offsetof(bt_at_send_key_value_param_args_t, para3)
    },
};
#endif
...
at_ret_t bt_at_sle_rf_tx_cmd(const sle_rf_tx_param_args_t *args)
{
    ...
    rf_tx_start.tx_freq = (uint16_t)args->tx_freq;
...
at_ret_t bt_at_sle_rf_rx_cmd(const sle_rf_rx_param_args_t *args)
{
    ...
    rf_rx_start.rx_freq = (uint16_t)args->rx_freq;
    rf_rx_start.rx_phy = (uint8_t)args->rx_phy;
...
at_ret_t bt_at_read_dieid_cmd(void)
{
    ...
    writel(EFUSE_READ_ENABLE_REG_ADDR, EFUSE_READ_ENABLE);
    for (index = 0; index < DIEID_EFUSE_WORD_LEN; index++) {
        osal_printk("%04x ", readw(DIEID_EFUSE_BASE_ADDR + index * 0x4));
    }
    osal_printk("\r\n");
    return AT_RET_OK;
}
...
{
    uint8_t *p_value = (uint8_t *)&args->sle_addr0;

    mp_test_set_addr(p_value);
...
at_ret_t bt_at_stay_work_state(void)
{
    ...
    extern void mouse_battery_level_detect_timer_stop(void);
    mouse_battery_level_detect_timer_stop();
    uapi_pm_set_state_trans_duration(0xFFFFFFFF, 0xFFFFFFFF);
#else
    osal_printk("STAYWORK unused!\r\n");
#endif
    return AT_RET_OK;
}
...
{
    uint8_t key_value[3] = {0};  /* key_max_num = 3 */
    key_value[0] = args->para1;  /* key_idx = 0 */
    key_value[1] = args->para2;  /* key_idx = 1 */
    key_value[2] = args->para3;  /* key_idx = 2 */
    keyscan_info_report_at_cmd(args->key_nums, key_value);
    return AT_RET_OK;
}
#endif
