...
#define AT_WRITE_ADDR_FLASH_PARAM_NUM 12
#define AT_WRITE_FEM_FLAG_PARAM_NUM 2
#define AT_WRITE_KEY_VALUE_PARAM_NUM 4
...
typedef struct {
    ...
    int32_t para2;
    int32_t para3;
} bt_at_send_key_value_param_args_t;
...
typedef struct {
    ...
    uint8_t ble_addr4;
    uint8_t ble_addr5;
} bt_write_addr_flash_param_args_t;
...
extern const at_para_parse_syntax_t bt_write_addr_flash_param_syntax[AT_WRITE_ADDR_FLASH_PARAM_NUM];
extern const at_para_parse_syntax_t write_fem_flag_param_syntax[AT_WRITE_FEM_FLAG_PARAM_NUM];
extern const at_para_parse_syntax_t bt_at_send_key_value_param_syntax[AT_WRITE_KEY_VALUE_PARAM_NUM];
