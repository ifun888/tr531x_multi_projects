...
static diag_reg_dump_t g_reg_dump_info[] = {
    { "PMU1", 0x57004000, 0x570047e0 },      // PMU1_CTL
    { "PMU2", 0x57008000, 0x57008490 },      // PMU2_CTL
    { "ULPA", 0x5702c000, 0x5702c418 },      // ULP_AON_CTL
};
...
static diag_mem_dump_t g_mem_dump_info[] = {
    { "ITCM", APP_ITCM_ORIGIN, APP_ITCM_LENGTH },
    { "DTCM", APP_DTCM_ORIGIN, APP_DTCM_LENGTH },
    { "TRACE", MCPU_TRACE_MEM_REGION_START, CPU_TRACE_MEM_REGION_LENGTH },
    { "BT_EM", 0x59410000, 16 * 1024 }, // 0x59410000 蓝牙em地址，一共16 * 1024 (16K)
};
