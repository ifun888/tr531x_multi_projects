...
#elif (defined BT_VERSION_STRING)
#define FIRMWARE_VERSION_STRING BT_VERSION_STRING
#else
...
{
    return ((build_version_info *)SSB_VERSION_LOAD_ORIGIN)->string;
}
#else
...
{
#ifdef BT_VERSION_LOAD_ORIGIN
    return ((build_version_info *)BT_VERSION_LOAD_ORIGIN)->string;
#else
    return NULL;
#endif
}