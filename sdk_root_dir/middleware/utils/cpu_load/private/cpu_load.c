...
#if (CHIP_SW39 == 1 || CHIP_SW21 == 1 || CHIP_SOCMN2 == 1)
...
#ifndef CONFIG_BT_SUPPORT_REAL_ROM
     {SECTION_TYPE_RELOAD, &__rom_text_begin__, &__rom_text_end__, BT_ROM_FLASH_REGION_START, RESEVED_VALUE},
#endif
...
#elif (CHIP_SW39 == 1 || CHIP_SW21 == 1 || CHIP_SOCMN2 == 1)
uint32_t* cpu_load_translate_into_mcu_xip_addr(uint32_t *addr, core_images_e image)
{
    /* loadaddr must be non-zero for translate */
