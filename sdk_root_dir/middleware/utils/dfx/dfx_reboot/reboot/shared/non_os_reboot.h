...
#if defined(EXCEPTION_TEST_ENABLE) && EXCEPTION_TEST_ENABLE == YES && defined(SUPPORT_IPC)
...
#if CORE == APPS && (defined(EXCEPTION_TEST_ENABLE) && EXCEPTION_TEST_ENABLE == YES) && defined(SUPPORT_IPC)
/**
