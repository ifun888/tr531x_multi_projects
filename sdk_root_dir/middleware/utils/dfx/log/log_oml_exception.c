/*
 * Copyright (c) Triductor. 2018-2019. All rights reserved.
...
#if defined(FLASH_DUMP_START) && (FLASH_DUMP_START != 0)
                                        ...
                                        uint32_t irq_id, const exc_context_t *exc_buf_addr)
{
    ...
    last_run_info->sp_value = exc_buf_addr->task_context.sp;
    last_run_info->ra_value = exc_buf_addr->task_context.ra;
    last_run_info->mepc_value = exc_buf_addr->task_context.mepc;
    last_run_info->gp_value = exc_buf_addr->gp;
    last_run_info->mstatus_value = exc_buf_addr->task_context.mstatus;
    last_run_info->mtval_value = exc_buf_addr->mtval;
    last_run_info->ccause_value = exc_buf_addr->ccause;
    last_run_info->mcause_value = exc_buf_addr->mcause;
