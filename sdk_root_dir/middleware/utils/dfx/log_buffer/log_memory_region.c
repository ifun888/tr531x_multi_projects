...
#endif
#if defined(CHIP_SW21) && (CHIP_SW21 != 0)
#define GNSS_CORE_LOGGING_OFFSET        ((HIFI_CORE_LOGGING_OFFSET) + (DSP_LOGGING_LENGTH))
#define SENSOR_CORE_LOGGING_OFFSET      ((GNSS_CORE_LOGGING_OFFSET) + (GNSS_LOGGING_LENGTH))
#endif
...
#if defined(CHIP_SW21) && (CHIP_SW21 != 0)
    initial_ctrl->offset[LOG_MEMORY_REGION_SECTION_3] = GNSS_CORE_LOGGING_OFFSET;
    initial_ctrl->offset[LOG_MEMORY_REGION_SECTION_4] = SENSOR_CORE_LOGGING_OFFSET;
#endif
