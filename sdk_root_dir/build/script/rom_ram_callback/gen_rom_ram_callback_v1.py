#!/usr/bin/env python
# coding:utf-8
# Copyright (c) Triductor. 2021-2030. All rights reserved.
...
def rom_gen_arm32_assemfile():
    with open(argv_list[rom_file_str], "w+") as rom_file:
        print("/*", file=rom_file)
        print(" * Copyright (c) Triductor. 2022-2022. All rights reserved.", file=rom_file)
...
def rom_gen_riscv32_assemfile():
    with open(argv_list[rom_file_str], "w+") as rom_file:
        print("/*", file=rom_file)
        print(" * Copyright (c) Triductor. 2021-2030. All rights reserved.", file=rom_file)
...
def rom_gen_macros_redefine_file():
    with open(argv_list[auto_redefine_macro_file_str], "w+") as auto_redefine_macro_file:
        ...
        print(" * Copyright (c) Triductor. 2021-2030. All rights reserved.",
