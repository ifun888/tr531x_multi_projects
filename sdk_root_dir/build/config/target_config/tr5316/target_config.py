...
target_template = {
    'target_tr5316_application_template': {
        'chip': 'tr5316',
        'chip_family': 'tr531x',
        'core': 'acore',
        'board': 'evb',
        ...
        'os': 'liteos',
        'std_libs': [],
        'defines': ['-:CHIP_TR5316=1', 'LIBCPU_UTILS', 'LIBLIB_UTILS', 'PRE_ASIC', 'LIBPANIC', 'LIBAPP_VERSION',
                    'VERSION_STANDARD', 'LIBBUILD_VERSION', "CONFIG_UART_FIFO_DEPTH=64", 'FLASH_1M',
                    'LIBTEST_COMMON', '_ALL_SOURCE', 'LOSCFG_MEM_TASK_STAT', 'SUPPORT_CXX', 'TR5316_PRODUCT_EVB',
        ...
        'auto_patch_cfg': True,
        'arch': 'riscv31',
        'sector_cfg': 'tr5316-standard',
        'loaderboot_cfg': 'loaderboot-tr5316-n1100',
        'flashboot_cfg': 'flashboot-tr5316-n1100',
        'nv_cfg': 'tr5316_nv_default',
        'gen_sec_bin': True,
