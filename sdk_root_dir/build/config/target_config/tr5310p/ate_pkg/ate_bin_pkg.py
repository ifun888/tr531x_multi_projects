...
def main():
    app_bin_path = os.path.join(g_root, "output", "tr5310p", "acore", "ate-application-tr5310p", "ate_sign.bin")
    patition_bin_path = os.path.join(g_root, "interim_binary", "tr5310p", "bin", "partition", "ate-application-tr5310p", "partition.bin")
    output_bin_path = os.path.join(g_root, "output", "tr5310p", "acore", "ate-application-tr5310p", "ate_pkg.bin")
    output_hex_path = os.path.join(g_root, "output", "tr5310p", "acore", "ate-application-tr5310p", "ate_pkg.hex")
    itcm_size = 32
