...
try:
    from .sdk_libs import tr531x_sdk_libs, tr531x_ci_sdk_libs, tr531x_cy_sdk_libs
except ImportError:
    print("[Warning]:sdk libs import failed.")

target = {
    'standard-tr5310p-s': {
        'base_target_name': 'target_tr5310p_application_template',
        'pkg_chip': 'tr5310p-s',
        'defines': [
            'FLASH_1M', 'USE_RSA3072_SIGN', 'SUPPORT_CFBB_UPG', 'BGLE_TASK_EXIST', 'SUPPORT_MULTI_LIBS',
            'SW_UART_DEBUG', 'AT_COMMAND', 'XO_32M_CALI', 'SUPPORT_CHIP_N1200', 'CONFIG_OTA_UPDATE_SUPPORT'
        ],
        'ram_component': [
            # Application Region
        ...
        'ram_component_set' : [
            'efuse_v151', 'spi', 'qdec', 'pdm', 'sio_v151', 'dmav151', 'keyscan', 'std_common_lib', 'pwm',
        ...
        'loaderboot_cfg': 'loaderboot-tr5310p-s',
        'flashboot_cfg': 'flashboot-tr5310p-s',
        'sector_cfg': 'tr5310p-standard-1m',
    },
}
...
# <pack_target> means target_group key_name (like pack_tr5310p_standard)
target_copy = {
