...
target_template = {
    'target_tr5310p_application_template': {
        'chip': 'tr5310p',
        'chip_family': 'tr531x',
        'core': 'acore',
        'board': 'evb',
        ...
        'os': 'liteos',
        'std_libs': [],
        'defines': ['-:CHIP_TR5310P=1', 'LIBCPU_UTILS', 'LIBLIB_UTILS', 'PRE_ASIC', 'LIBPANIC', 'LIBAPP_VERSION',
                    'VERSION_STANDARD', 'LIBBUILD_VERSION', "CONFIG_UART_FIFO_DEPTH=64", 'FLASH_SECBOOT_SIZE=0x1000',
                    'LIBTEST_COMMON', '_ALL_SOURCE', 'LOSCFG_MEM_TASK_STAT', 'SUPPORT_CXX', 'TR5310P_PRODUCT_EVB',
                    ...
                    "CONFIG_NV_SUPPORT_SINGLE_CORE_SYSTEM", 'CONFIG_NV_FEATURE_SUPPORT', "DFU_IN_FLASHBOOT=0", 'TEST_SUITE',
        ...
        'arch': 'riscv31',
        'sector_cfg': 'tr5310p-standard-512k',
        'loaderboot_cfg': 'loaderboot-tr5310p-n1100',
        'flashboot_cfg': 'flashboot-tr5310p-n1100',
        'nv_cfg': 'tr5310p_nv_default',
