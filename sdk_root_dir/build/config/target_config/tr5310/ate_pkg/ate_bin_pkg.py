...
def main():
    app_bin_path = os.path.join(g_root, "output", "tr5310", "acore", "ate-application-tr5310", "ate_sign.bin")
    patition_bin_path = os.path.join(g_root, "interim_binary", "tr5310", "bin", "boot_bin", "partition.bin")
    output_bin_path = os.path.join(g_root, "output", "tr5310", "acore", "ate-application-tr5310", "ate_pkg.bin")
    output_hex_path = os.path.join(g_root, "output", "tr5310", "acore", "ate-application-tr5310", "ate_pkg.hex")
    itcm_size = 80
