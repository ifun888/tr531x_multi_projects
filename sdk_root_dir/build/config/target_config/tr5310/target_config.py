...
target_template = {
    'target_tr5310_application_template': {
        'chip': 'tr5310',
        'chip_family': 'tr531x',
        'core': 'acore',
        'board': 'evb',
        ...
        'os': 'liteos',
        'std_libs': [],
        'defines': ['-:CHIP_TR5310=1', 'LIBCPU_UTILS', 'LIBLIB_UTILS', 'PRE_ASIC', 'LIBPANIC', 'LIBAPP_VERSION',
                    'VERSION_STANDARD', 'LIBBUILD_VERSION', "CONFIG_UART_FIFO_DEPTH=64", 'FLASH_1M',
                    'LIBTEST_COMMON', '_ALL_SOURCE', 'LOSCFG_MEM_TASK_STAT', 'SUPPORT_CXX', 'TR5310_PRODUCT_EVB',
                    ...
                    'LIBUTIL_COMPAT', "LITEOS_208", "BTH_LOG_BUG_FIX", 'OSALLOG_DISABLE', 'SUPPORT_DIAG_V2_PROTOCOL', 'TEST_SUITE', 'SUPPORT_CPU_TRACE_PRINT',
                    'SUPPORT_HEAP_PRINT', 'OSAL_LIST_POISON_NULL', 'LOG_WRITE_WITH_NOLOCK','TEST_SUITE','XO_32M_CALI'],
        ...
        'ram_component_set': ['-:codec_set', 'cpu', 'i2c', 'lpc', 'cpu_trace', 'gpio_v150', 'time_set', 'mem',
        ...
        'fixed_rom': True,
        'fixed_rom_path': '<root>/drivers/chips/tr531x/rom/rom_bin/rom_n1100/application_rom.bin',
        'rom_sym_path': '<root>/drivers/chips/tr531x/rom/rom_info/acore/acore.sym',
        'rom_ram_check': True,
        ...
        'auto_patch_cfg': True,
        'arch': 'riscv31',
        'sector_cfg': 'tr5310-standard',
        'nv_cfg': 'tr5310_nv_default',
        # 编译时重新生成kconfig，保证.config与最新kconfig框架同步
        'reload_kconfig': True,
        'image_version': 'c0g',
        'gen_sec_bin': True,
        'loaderboot_cfg': 'loaderboot-tr5310-n1100',
        'flashboot_cfg': 'flashboot-tr5310-n1100',
    },
}
