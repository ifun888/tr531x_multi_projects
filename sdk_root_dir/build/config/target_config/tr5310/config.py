...
target = {
    'standard-tr5310-s': {
        'base_target_name': 'target_tr5310_application_template',
        'pkg_chip': 'tr5310-s',
        'defines': [
            'FLASH_1M', "USE_RSA3072_SIGN", 'SUPPORT_CFBB_UPG', 'BGLE_TASK_EXIST', 'SUPPORT_MULTI_LIBS',
            'SW_UART_DEBUG', 'AT_COMMAND', 'XO_32M_CALI', 'SUPPORT_CHIP_N1200', 'CONFIG_OTA_UPDATE_SUPPORT', 'SUPPORT_BTC_RUN_IN_RAM'
        ],
        'ram_component': [
            # Application Region
        ...
        'upg_pkg':['application'],
        'loaderboot_cfg': 'loaderboot-tr5310-s',
        'flashboot_cfg': 'flashboot-tr5310-s',
    },
}
...
# <pack_target> means target_group key_name (like pack_tr5310_standard)
target_copy = {
