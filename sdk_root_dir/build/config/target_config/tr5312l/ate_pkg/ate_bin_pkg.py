...
def main():
    app_bin_path = os.path.join(g_root, "output", "tr5312l", "acore", "ate-application-tr5312l", "ate_sign.bin")
    patition_bin_path = os.path.join(g_root, "interim_binary", "tr5312l", "bin", "boot_bin", "partition.bin")
    output_bin_path = os.path.join(g_root, "output", "tr5312l", "acore", "ate-application-tr5312l", "ate_pkg.bin")
    output_hex_path = os.path.join(g_root, "output", "tr5312l", "acore", "ate-application-tr5312l", "ate_pkg.hex")
    itcm_size = 80
