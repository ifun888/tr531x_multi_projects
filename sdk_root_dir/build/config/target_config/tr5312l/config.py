...
target = {
    'standard-tr5312l-s': {
        'base_target_name': 'target_tr5312l_application_template',
        'pkg_chip': 'tr5312l-s',
        'defines': [
        ...
        'upg_pkg': ['application'],
        'loaderboot_cfg': 'loaderboot-tr5312l-s',
        'flashboot_cfg': 'flashboot-tr5312l-s'
    },
}
...
# <pack_target> means target_group key_name (like pack_tr5312l_standard)
target_copy = {
