...
target_template = {
    'target_tr5312l_application_template': {
        'chip': 'tr5312l',
        'chip_family': 'tr531x',
        'core': 'acore',
        'board': 'evb',
        ...
        'os': 'liteos',
        'std_libs': [],
        'defines': ['-:CHIP_TR5312L=1', 'LIBCPU_UTILS', 'LIBLIB_UTILS', 'PRE_ASIC', 'LIBPANIC', 'LIBAPP_VERSION',
                    'VERSION_STANDARD', 'LIBBUILD_VERSION', "CONFIG_UART_FIFO_DEPTH=64", 'FLASH_1M',
                    'LIBTEST_COMMON', '_ALL_SOURCE', 'LOSCFG_MEM_TASK_STAT', 'SUPPORT_CXX', 'TR5312L_PRODUCT_EVB',
                    ...
                    "CONFIG_NV_SUPPORT_SINGLE_CORE_SYSTEM", 'CONFIG_NV_FEATURE_SUPPORT', 'FLASH_SECBOOT_SIZE=0x1000','TEST_SUITE',
                    'LIBUTIL_COMPAT', "LITEOS_208", "BTH_LOG_BUG_FIX", 'OSALLOG_DISABLE', 'SUPPORT_DIAG_V2_PROTOCOL', 'SUPPORT_CPU_TRACE_PRINT',
                    'SUPPORT_HEAP_PRINT', 'OSAL_LIST_POISON_NULL', 'LOG_WRITE_WITH_NOLOCK'],
        ...
        'auto_patch_cfg': True,
        'arch': 'riscv31',
        'sector_cfg': 'tr5312l-standard',
        'nv_cfg': 'tr5312l_nv_default',
        # 编译时重新生成kconfig，保证.config与最新kconfig框架同步
        'reload_kconfig': True,
        'image_version': 'c2g',
        'gen_sec_bin': True,
        'loaderboot_cfg': 'loaderboot-tr5312l-n1100',
        'flashboot_cfg': 'flashboot-tr5312l-n1100',
    },
}
