...
if(NOT "SDK_NOT_MEM_LIMIT" IN_LIST DEFINES)
    add_custom_target(GENERAT_MEM_LIMIT ALL
        COMMENT "MEM_LIMIT"
        COMMAND ${Python3_EXECUTABLE} ${PARSE_MAP_SIZE_INFO} ${BIN_NAME}.lst ${BIN_NAME}.map ${BUILD_TARGET_NAME}
        WORKING_DIRECTORY ${PROJECT_BINARY_DIR}
        DEPENDS "${TARGET_NAME};GENERAT_LST")
...
if (${CHIP} MATCHES "tr5310|tr5310p|tr5310pa|tr5310pe|tr5312l|tr5316")
    set(TARGET_SYM ${ROOT_DIR}/drivers/chips/tr531x/rom/rom_config/${CORE}/${BIN_NAME}.sym)
else()
