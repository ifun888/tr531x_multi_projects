if(CHIP STREQUAL "trswgxx")
    include (${WIFI_DIR}/wifi_alg_trswgxx.cmake)
    add_subdirectory(${WIFI_DIR}/com_code/alg wifi_alg)
elseif(CHIP STREQUAL "brandy")
    include (${WIFI_DIR}/wifi_alg_brandy.cmake)
    add_subdirectory(${WIFI_DIR}/com_code/alg wifi_alg)
elseif(CHIP STREQUAL "sw21")
    include (${WIFI_DIR}/wifi_alg_sw21.cmake)
    add_subdirectory(${WIFI_DIR}/com_code/alg wifi_alg)
elseif(CHIP STREQUAL "tr5336")
    if(DEFINED LLT_PATH)
        include (${WIFI_DIR}/wifi_alg_tr5336.cmake)
        add_subdirectory(${WIFI_DIR}/com_code/alg wifi_alg)
    endif()
elseif(DEFINED CHIP)
    return()
else()
    set(project_name tr5330)
    add_subdirectory(${WIFI_DIR}/com_code/alg wifi_alg)
    include (${WIFI_DIR}/wifi_alg_tr5330.cmake)
endif()
