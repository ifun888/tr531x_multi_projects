...
void exit_(int32_t *);
char *mktemp(char *);
int32_t f__canseek(FILE *);
int32_t f_clos(cllist *);
// f2c.h声明
long ftello(FILE *arg1);
int fseeko(FILE *arg1, long arg2, int arg3);
int fflush(FILE *arg1);
int ungetc(int arg1, FILE *arg2);
int getc(FILE *arg);
int putc(int arg1, FILE *arg2);
char *F77_aloc(int32_t Len, const char *whence);
void c_div(complex *, complex *, complex *);
float f__cabs(float real_num, float imag);
void sig_die(const char *s, int32_t kill);
