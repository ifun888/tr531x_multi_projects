...
if ((${CHIP} STREQUAL "tr5336") OR (${CHIP} STREQUAL "trswgxx") OR (${CHIP} STREQUAL "sw21"))
    list(APPEND PRIVATE_DEFINES
        WS_IOT_LWIP_C
    )
endif()

if ((NOT ${CHIP} STREQUAL "tr5336") AND (NOT ${CHIP} STREQUAL "trswgxx"))
	list(APPEND SOURCES
		${ROOT_DIR}/open_source/mbedtls/mbedtls_v3.6.0/library/psa_crypto_aead.c
		${ROOT_DIR}/open_source/mbedtls/mbedtls_v3.6.0/library/psa_crypto_cipher.c
		${ROOT_DIR}/open_source/mbedtls/mbedtls_v3.6.0/library/psa_crypto_client.c
...
list(APPEND PUBLIC_HEADER
    ${ROOT_DIR}/drivers/drivers/driver/security_unified/mbedtls_harden_adapt/mbedtls_alt
    ${ROOT_DIR}/drivers/drivers/driver/security_unified/mbedtls_harden_adapt/mbedtls_alt/include
)
...
if ((${CHIP} STREQUAL "brandy") OR (${CHIP} STREQUAL "sw21"))
	...
	list(APPEND SOURCES
		${ROOT_DIR}/open_source/mbedtls/mbedtls_v3.6.0/harden/src/entropy_harden.c
		${ROOT_DIR}/open_source/mbedtls/mbedtls_v3.6.0/harden/src/cipher_adapt.c
	)

	list(APPEND PRIVATE_HEADER
		${ROOT_DIR}/open_source/mbedtls/mbedtls_v3.6.0/harden/src/internal_include
		${ROOT_DIR}/open_source/mbedtls/mbedtls_v3.6.0/harden/platform/wearable
		${ROOT_DIR}/open_source/mbedtls/mbedtls_v3.6.0/harden/cipher_adapt_include
	)
elseif ((${CHIP} STREQUAL "tr5336") OR (${CHIP} STREQUAL "trswgxx"))
	list(APPEND PRIVATE_HEADER
		${ROOT_DIR}/open_source/mbedtls/mbedtls_v3.6.0/configs/vendor
	)
	list(APPEND PUBLIC_HEADER
		${ROOT_DIR}/open_source/mbedtls/mbedtls_v3.6.0/configs/vendor
	)
...
if("MBEDTLS_HARDEN_OPEN" IN_LIST DEFINES)
	...
	list(APPEND SOURCES
        ${ROOT_DIR}/drivers/drivers/driver/security_unified/mbedtls_harden_adapt/mbedtls_alt/aes_harden_adapt.c
        ${ROOT_DIR}/drivers/drivers/driver/security_unified/mbedtls_harden_adapt/mbedtls_alt/aes.c
        ${ROOT_DIR}/drivers/drivers/driver/security_unified/mbedtls_harden_adapt/mbedtls_alt/bignum.c
        ${ROOT_DIR}/drivers/drivers/driver/security_unified/mbedtls_harden_adapt/mbedtls_alt/ecdh.c
        ${ROOT_DIR}/drivers/drivers/driver/security_unified/mbedtls_harden_adapt/mbedtls_alt/ecdsa.c
        # ${ROOT_DIR}/drivers/drivers/driver/security_unified/mbedtls_harden_adapt/mbedtls_alt/ecp_curves.c
        ${ROOT_DIR}/drivers/drivers/driver/security_unified/mbedtls_harden_adapt/mbedtls_alt/ecp_harden_adapt.c
        ${ROOT_DIR}/drivers/drivers/driver/security_unified/mbedtls_harden_adapt/mbedtls_alt/ecp.c
        ${ROOT_DIR}/drivers/drivers/driver/security_unified/mbedtls_harden_adapt/mbedtls_alt/hash_harden_adapt.c
        # ${ROOT_DIR}/drivers/drivers/driver/security_unified/mbedtls_harden_adapt/mbedtls_alt/hkdf.c
        ${ROOT_DIR}/drivers/drivers/driver/security_unified/mbedtls_harden_adapt/mbedtls_alt/mbedtls_alt_utils.c
        ${ROOT_DIR}/drivers/drivers/driver/security_unified/mbedtls_harden_adapt/mbedtls_alt/pkcs5.c
        ${ROOT_DIR}/drivers/drivers/driver/security_unified/mbedtls_harden_adapt/mbedtls_alt/sha1.c
        ${ROOT_DIR}/drivers/drivers/driver/security_unified/mbedtls_harden_adapt/mbedtls_alt/sha256.c
        ${ROOT_DIR}/drivers/drivers/driver/security_unified/mbedtls_harden_adapt/mbedtls_alt/sha512.c
	)
elseif("FUZZ_TEST" IN_LIST DEFINES)
    ...
    list(APPEND COMPONENT_CCFLAGS
        -O0 # fix compile error for fuzz test
    )
else()
