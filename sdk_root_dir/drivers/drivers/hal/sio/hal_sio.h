 ...
 * @endif
 */
typedef enum hal_sio_timing_mode {
 ...
 * @endif
 */
errcode_t hal_sio_init(sio_bus_t bus);
 ...
 * @endif
 */
void hal_sio_deinit(sio_bus_t bus);
 ...
 * @endif
 */
void hal_sio_set_config(sio_bus_t bus, const hal_sio_config_t *config);
 ...
 * @endif
 */
errcode_t hal_sio_get_config(sio_bus_t bus, hal_sio_config_t *config);
 ...
 * @endif
 */
void hal_sio_read(sio_bus_t bus, bool en);
 ...
 * @endif
 */
void hal_sio_write(sio_bus_t bus, hal_sio_tx_data_t *data, hal_sio_mode_t mode);
 ...
 * @endif
 */
void hal_sio_get_data(sio_bus_t bus, hal_sio_rx_data_t *data);
 ...
 * @endif
 */
void hal_sio_set_loop_mode(sio_bus_t bus, bool en);
 ...
 * @endif
 */
void hal_sio_start_loop_trans(sio_bus_t bus, hal_sio_tx_data_t *data, hal_sio_mode_t mode);
 ...
 * @endif
 */
void hal_sio_set_dma_config(sio_bus_t bus, hal_i2s_dma_attr_t *attr);
 ...
 * @endif
 */
void hal_sio_register_callback(sio_bus_t bus, hal_sio_callback_t callback);
 ...
 * @endif
 */
void hal_sio_unregister_callback(sio_bus_t bus);
