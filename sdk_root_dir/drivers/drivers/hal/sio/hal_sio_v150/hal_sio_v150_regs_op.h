 ...
 */
static inline void hal_sio_v150_ct_set_set_tx_enable(sio_bus_t bus, uint32_t val)
{
    sio_v150_ct_set_data_t ct_set;
    ct_set.d32 = sios_v150_regs(bus)->ct_set;
 ...
 */
static inline void hal_sio_v150_ct_set_set_rx_enable(sio_bus_t bus, uint32_t val)
{
    sio_v150_ct_set_data_t ct_set;
    ct_set.d32 = sios_v150_regs(bus)->ct_set;
...
/**
 * @brief Set the value of @ref sio_v150_i2s_pos_merge_en_data.merge_en.
 * @param  [in]  bus The index of sio. @ref sio_bus_t @ref sio_bus_t.
 * @param  [in]  val The value of @ref sio_v150_i2s_pos_merge_en_data.merge_en.
 */
...
/**
 * @brief Set the value of @ref sio_v150_intmask_data.
 * @param  [in]  bus The index of sio. @ref sio_bus_t @ref sio_bus_t.
 * @param  [in]  intmask The value of @ref sio_v150_intmask_data.
 */
static inline void hal_sio_v150_set_intmask(sio_bus_t bus, uint32_t intmask)
{
