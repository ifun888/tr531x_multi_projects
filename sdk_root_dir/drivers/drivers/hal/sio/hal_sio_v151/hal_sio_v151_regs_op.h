 ...
 */
static inline uint32_t hal_sio_v151_start_pos_get_start_pos_read(sio_bus_t bus)
{
 ...
 */
static inline void hal_sio_v151_start_pos_set_start_pos_read(sio_bus_t bus, uint32_t val)
{
    sio_v151_i2s_start_pos_data_t start_pos;
    start_pos.d32 = sios_v151_regs(bus)->i2s_start_pos;
 ...
 */
static inline uint32_t hal_sio_v151_start_pos_get_start_pos_write(sio_bus_t bus)
{
    sio_v151_i2s_start_pos_data_t start_pos;
    start_pos.d32 = sios_v151_regs(bus)->i2s_start_pos;
 ...
 */
static inline void hal_sio_v151_start_pos_set_start_pos_write(sio_bus_t bus, uint32_t val)
{
    sio_v151_i2s_start_pos_data_t start_pos;
    start_pos.d32 = sios_v151_regs(bus)->i2s_start_pos;
 ...
 */
static inline uint32_t hal_sio_v151_pos_flag_get_start_pos_read(sio_bus_t bus)
{
 ...
 */
static inline void hal_sio_v151_pos_flag_set_start_pos_read(sio_bus_t bus, uint32_t val)
{
    sio_v151_pos_flag_data_t pos_flag;
    pos_flag.d32 = sios_v151_regs(bus)->i2s_pos_flag;
 ...
 */
static inline uint32_t hal_sio_v151_pos_flag_get_start_pos_write(sio_bus_t bus)
{
    sio_v151_pos_flag_data_t pos_flag;
    pos_flag.d32 = sios_v151_regs(bus)->i2s_pos_flag;
 ...
 */
static inline void hal_sio_v151_pos_flag_set_start_pos_write(sio_bus_t bus, uint32_t val)
{
    sio_v151_pos_flag_data_t pos_flag;
    pos_flag.d32 = sios_v151_regs(bus)->i2s_pos_flag;
...
/**
 * @brief Set the value of @ref sio_v151_intmask_data.
 * @param  [in]  bus The index of sio. @ref sio_bus_t @ref sio_bus_t.
 * @param  [in]  mask The value of @ref sio_v151_intmask_data.
 */
static inline void hal_sio_v151_set_intmask(sio_bus_t bus, uint32_t mask)
{
...
static inline uint32_t hal_sio_v151_get_merge_rx_data(sio_bus_t bus)
{
    uint32_t i2s_rd;
