...
void hal_keyscan_config_key_select_num(uint32_t sel)
{
    ...
    key_select_num_t key_select_num = SELECT_SIX_KEYS_PER_SCAN;
    switch (sel) {
        case 0x6:
            key_select_num = SELECT_SIX_KEYS_PER_SCAN;
            break;
        case 0x7:
            key_select_num = SELECT_SEVEN_KEYS_PER_SCAN;
            break;
        case 0x8:
            key_select_num = SELECT_EIGHT_KEYS_PER_SCAN;
            break;
        case 0xa:
            key_select_num = SELECT_TEN_KEYS_PER_SCAN;
            break;
        default:
            key_select_num = SELECT_SIX_KEYS_PER_SCAN;
            break;
    ...
    keyscan_de.b.key_num_sel = key_select_num;
