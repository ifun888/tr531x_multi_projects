...
#elif (CORE == BT) || (CORE == CONTROL_CORE) || (CORE == SENSOR)
/* for bcpu trace */
#define HAL_PCLR_EN_BIT                                 1
...
#if (CHIP_LIBRA && (CORE != GNSS)) || CHIP_SOCMN1 || CHIP_TR5312
...
{
#if (CORE == APPS) || (CORE == BT) || (CORE == CONTROL_CORE) || (CORE == SENSOR)
...
#ifdef CONFIG_TRACE_IP_VERSION_V150
    regw_setbit((void *)(uintptr_t)HAL_CPU_TRACE_CTL_RB_BASE_ADDR, HAL_CFG_MONITOR_SEL_REG_OFFSET,
