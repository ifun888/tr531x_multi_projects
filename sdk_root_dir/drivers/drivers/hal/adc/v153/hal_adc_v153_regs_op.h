...
static inline void hal_afe_count_mode_set(afe_scan_mode_t afe_scan_mode)
{
    if (afe_scan_mode != AFE_GADC_MODE) { return; }
    cfg_gadc_data0_t cfg_adc_data0 = { 0 };
    cfg_adc_data0.b.data_num = 0xF;
    cfg_adc_data0.b.wait_num = 0x4;
    cfg_adc_data0.b.cont_mode = COUNT_MODE;
    cfg_gadc_data1_t cfg_adc_data1 = { 0 };
    cfg_adc_data1.b.osr_len = 0x3;
    cfg_adc_data1.b.osr_sel = 0x3;
    g_adc_regs->cfg_gadc_data_0 = cfg_adc_data0.d32;
    g_adc_regs->cfg_gadc_data_1 = cfg_adc_data1.d32;
}
