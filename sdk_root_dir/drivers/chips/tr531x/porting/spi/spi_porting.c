...
void spi_port_get_regs_value(spi_bus_t bus)
{
    ...
    for (uint32_t addr = spi_bus_addr; addr <= spi_bus_addr + 0x2C; addr += SPI_ADDR_OFFEST_BYTES) {
...
void spi_port_set_pin_config(spi_bus_t bus)
{
    if (bus == SPI_BUS_0) {
#if defined(CONFIG_PINCTRL_SUPPORT_IE)
        uapi_pin_set_ie(CONFIG_SPI_BUS0_CLK_PIN, PIN_IE_1);
        uapi_pin_set_ie(CONFIG_SPI_BUS0_CS_PIN, PIN_IE_1);
        uapi_pin_set_ie(CONFIG_SPI_BUS0_DI_PIN, PIN_IE_1);
#endif /* CONFIG_PINCTRL_SUPPORT_IE */
        uapi_pin_set_mode(CONFIG_SPI_BUS0_CLK_PIN, HAL_PIO_SPI0_SCLK);
        uapi_pin_set_mode(CONFIG_SPI_BUS0_CS_PIN, HAL_PIO_SPI0_CS0);
        uapi_pin_set_mode(CONFIG_SPI_BUS0_DI_PIN, HAL_PIO_SPI0_RXD);
        uapi_pin_set_mode(CONFIG_SPI_BUS0_DO_PIN, HAL_PIO_SPI0_TXD);
    } else if (bus == SPI_BUS_1) {
#if defined(CONFIG_PINCTRL_SUPPORT_IE)
        uapi_pin_set_ie(CONFIG_SPI_BUS1_CLK_PIN, PIN_IE_1);
        uapi_pin_set_ie(CONFIG_SPI_BUS1_CS_PIN, PIN_IE_1);
        uapi_pin_set_ie(CONFIG_SPI_BUS1_DI_PIN, PIN_IE_1);
#endif /* CONFIG_PINCTRL_SUPPORT_IE */
        uapi_pin_set_mode(CONFIG_SPI_BUS1_CLK_PIN, HAL_PIO_SPI1_CLK);
        uapi_pin_set_mode(CONFIG_SPI_BUS1_CS_PIN, HAL_PIO_SPI1_CS0);
        uapi_pin_set_mode(CONFIG_SPI_BUS1_DI_PIN, HAL_PIO_SPI1_RXD);
        uapi_pin_set_mode(CONFIG_SPI_BUS1_DO_PIN, HAL_PIO_SPI1_TXD);
    } else if (bus == SPI_BUS_2) {
#if defined(CONFIG_PINCTRL_SUPPORT_IE)
        uapi_pin_set_ie(CONFIG_SPI_BUS2_CLK_PIN, PIN_IE_1);
        uapi_pin_set_ie(CONFIG_SPI_BUS2_CS_PIN, PIN_IE_1);
        uapi_pin_set_ie(CONFIG_SPI_BUS2_DI_PIN, PIN_IE_1);
#endif /* CONFIG_PINCTRL_SUPPORT_IE */
        uapi_pin_set_mode(CONFIG_SPI_BUS2_CLK_PIN, HAL_PIO_SPI2_CLK);
        uapi_pin_set_mode(CONFIG_SPI_BUS2_CS_PIN, HAL_PIO_SPI2_CS0);
        uapi_pin_set_mode(CONFIG_SPI_BUS2_DI_PIN, HAL_PIO_SPI2_RXD);
        uapi_pin_set_mode(CONFIG_SPI_BUS2_DO_PIN, HAL_PIO_SPI2_TXD);
    }
}