...
typedef enum {
    ...
    SSAP_OPERATE_INDICATION_BIT_DESCRITOR_WRITE = 0x100,  /*!< @if Eng data value description descriptor can be written                                                                      
                                                               @else   数据值说明描述符可被写入 @endif */
    SSAP_OPERATE_INDICATION_BIT_DESCRIPTOR_CLIENT_CONFIGURATION_WRITE = 0x200,   /*!< @if Eng client descriptor value can be written
                                                                                     @else 客户端描述符可被写入 @endif */
    SSAP_OPERATE_INDICATION_BIT_DESCRIPTOR_SERVER_CONFIGURATION_WRITE = 0x400,   /*!< @if Eng client descriptor value can be written
