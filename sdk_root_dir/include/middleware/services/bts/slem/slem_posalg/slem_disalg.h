 ...
 * @par Description:
 * @param  [in]  res        SLEM ranging result. see @ref slem_dis_result.
 ...
 * @brief  SLEM测距算法。
 * @par Description:
 * @param  [in]  res         SLEM测距结果。 参考 @ref slem_dis_result.
 * @param  [in]  para_ec     SLEM测距算法入参。 参考 @ref slem_para_cur_info。
 * @retval 执行结果错误码。参考 @ref errcode_slem。
 * @endif
 */
errcode_slem slem_alg_calc_dist(slem_dis_result *result, slem_para_dis_calc *para_ec);
#endif